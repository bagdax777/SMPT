...
public class WikiQueryTask {
    ...
    public static WikiResult queryWikipedia(String zapytanie) {
        try {
                    ...
                    if (pages != null) {
                        ...
                        while(keys.hasNext()) {
                            ...
                            if (images != null) {
                                ...
                                return new WikiResult(extract, imageLinks);
                            }
                        }
                    } else {
    ...
    public interface WikiQueryTaskResponse {
        void onQueryResult(WikiResult result);
    }
